...
def username(id):
    ...
    if len(gotRes) == 0:
        db.child("patients").child("userid").child(id).child("id").set(id)
        db.child("patients").child("userid").child(id).child("userStatus").set("400")
        return jsonify(badapiresponse)
    else:
        db.child("patients").child("userid").child(id).child("id").set(id)
        db.child("patients").child("userid").child(id).child("userStatus").set("200")
